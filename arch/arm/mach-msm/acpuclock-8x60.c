...
static struct msm_bus_paths bw_level_tbl[] = {
	[0] = BW_MBPS(1064), /* At least 133 MHz on bus. */
	[1] = BW_MBPS(1600), /* At least 200 MHz on bus. */
	[2] = BW_MBPS(2136), /* At least 267 MHz on bus. */
	[3] = BW_MBPS(3040), /* At least 380 MHz on bus. */
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[10] = { 918000,  1, 0x11, 1100000, 1100000, 1},
	...
	[16] = {1242000,  1, 0x17, 1200000, 1225000, 3},
...
static struct clkctl_acpu_speed acpu_freq_tbl_hate[] = {
  { {1, 1},  96000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   750000, 0x03006000},
  /* MAX_AXI row is used to source CPU cores and L2 from the AFAB clock. */
  { {0, 0},  MAX_AXI, ACPU_AFAB,  1, 0, 0, 0,    L2(0),   825000, 0x03006000},
  { {1, 1},  192000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   800000, 0x03006000},
  { {1, 1},  310000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   825000, 0x03006000},
  ...
  { {1, 0}, 1404000,  ACPU_SCPLL, 0, 0, 1, 0x1A, L2(19), 1150000, 0x03006000},
  { {1, 0}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(20), 1175000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(21), 1200000, 0x03006000},
  { {1, 0}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(22), 1225000, 0x03006000},
  { {1, 0}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(22), 1250000, 0x03006000},
...
{
	char *p = page;
	p += sprintf(p, "Much faster then a Palm pre 3");
	return p - page;
}
