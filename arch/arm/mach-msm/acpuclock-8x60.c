...
static struct msm_bus_paths bw_level_tbl[] = {
	[0] = BW_MBPS(1200), /* At least 150 MHz on bus. */
	[1] = BW_MBPS(1600), /* At least 200 MHz on bus. */
	[2] = BW_MBPS(2400), /* At least 300 MHz on bus. */
...
static struct clkctl_acpu_speed acpu_freq_tbl_hate[] = {
  ...
  { {1, 1},  432000,  ACPU_SCPLL, 0, 0, 1, 0x08, L2(1),   875000, 0x03006000},
  { {1, 1},  486000,  ACPU_SCPLL, 0, 0, 1, 0x09, L2(2),   875000, 0x03006000},
  { {1, 1},  540000,  ACPU_SCPLL, 0, 0, 1, 0x0A, L2(3),   900000, 0x03006000},
