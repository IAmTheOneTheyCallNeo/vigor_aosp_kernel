...
#define L_VAL_SCPLL_CAL_MAX	0x23 /* =  1836 MHz with 27MHz source */
...
static struct clkctl_acpu_speed acpu_freq_tbl_hate[] = {
  ...
  { {1, 0}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(19), 1175000, 0x03006000},
  { {1, 1}, 1512000,  ACPU_SCPLL, 0, 0, 1, 0x1C, L2(20), 1175000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(20), 1200000, 0x03006000},
  { {1, 0}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(21), 1200000, 0x03006000},
  { {1, 0}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(21), 1225000, 0x03006000},
