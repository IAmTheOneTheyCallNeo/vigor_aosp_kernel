/*
 *  drivers/cpufreq/cpufreq_scary.c
 *
 *  Scary governor based off of conservatives source with smartass features
 *
 ...
 *
 *  Updated and hacked up by iHateWEBos
 *
...
{
	cputime64_t idle_time = get_cpu_idle_time_us(cpu, NULL);
...
MODULE_DESCRIPTION("'cpufreq_scary' - A scary dynamic cpufreq governor for "
